...
# Purpose: Return the deBruijn sequence of a set of given kmers.
#   stderr: errors and status
#   stdout: any named out file of the users choosing.
#          
# Author: Mohammad Abdulqader (mabdulqa)
#
#   Notes: Problem 7 of 7 for Assignment 4
#                        
########################################################################
...
class Genome:
    ...
    def Visit(self, node):
        ...
        while len(self.Graph[currentNode]) > 0:
            adjNode = self.Graph[currentNode].pop() # pops next node
...
def main():
    ...
    try:
        ...
        kmers = [line.rstrip() for line in lines[1:]]
